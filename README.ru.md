...
Статус: **public beta 0.1.1**. Первая поддерживаемая конфигурация — Codex на macOS с Apple Silicon. Исходный код открыт по Apache License 2.0; ограничения beta и условия сторонних компонентов перечислены ниже.
