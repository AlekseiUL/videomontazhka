...
Во всех публичных документах этот ограниченный набор называется одинаково:
`verified default-branch revisions`. Термин не означает проверку всех remote refs.
